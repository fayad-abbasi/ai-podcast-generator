...
def main() -> None:
    ...
    print("\n" + "=" * 70)
    print("SUCCESS — set these three GitHub repository secrets")
    print("=" * 70)
    print(f"\nGMAIL_OAUTH_CLIENT_ID:\n{client_id}\n")
    print("GMAIL_OAUTH_CLIENT_SECRET:\n[REDACTED - do not print secrets]\n")
    print("GMAIL_OAUTH_REFRESH_TOKEN:\n[REDACTED - do not print secrets]\n")
    print("Use `client_secret.json` for GMAIL_OAUTH_CLIENT_SECRET.")
    print("Capture/store GMAIL_OAUTH_REFRESH_TOKEN via a secure channel only.")
    print("=" * 70)
